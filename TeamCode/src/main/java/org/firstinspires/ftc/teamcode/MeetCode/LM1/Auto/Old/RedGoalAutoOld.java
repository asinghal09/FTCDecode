...
@Config
@Autonomous
public class RedGoalAutoOld extends LinearOpMode{

    private static final Logger log = LoggerFactory.getLogger(RedGoalAutoOld.class);
    ...
    public void runOpMode(){
        ...
        Action backFromGoal = drive.actionBuilder(initialPose)
                .strafeToLinearHeading(new Vector2d(-30, 27),Math.toRadians(-52))
                .build();
