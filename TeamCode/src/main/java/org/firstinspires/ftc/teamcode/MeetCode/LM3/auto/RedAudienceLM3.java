...
@Config
@Autonomous
public class RedAudienceLM3 extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        Pose2d initialPose = new Pose2d(55, 16, Math.toRadians(-4));
        ...
        Action toGoal = drive.actionBuilder(initialPose)
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-28, 25,Math.toRadians(-52)), Math.toRadians(180))
                .build();
